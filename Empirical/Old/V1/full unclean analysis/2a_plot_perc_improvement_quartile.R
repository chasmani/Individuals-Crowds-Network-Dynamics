...
ggsave(paste0("Figures/", "quartile_none_1000.png"), dpi = 1000)
ggsave(paste0("Figures/", "quartile_5.5x4.5x100.png"), width = 5.5, height = 4.5, dpi = 1000)
ggsave(paste0("Figures/", "quartile_6x4.5x100.png"), width = 6, height = 4.5, dpi = 1000)
